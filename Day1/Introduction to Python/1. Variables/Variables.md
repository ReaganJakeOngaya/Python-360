# variables and print functions 
Variables in python are used to store information to be referenced and manipulated in a program. They do not use let, const, or var keywords like some other programming languages.
